...
concepts = {
  "kinds":
  "Objects in the game can be refered to by 'kinds'.\r\nexample: 'get weapon'",
  ...
  "plurality":
  "You can refer to plural groups of things by using a plural form of a kind.\r\nexample:{#yellow} 'objects', 'weapons', 'containers', 'women', 'books.'",

  "adjectives":
  "adjectives can be used to filter the object/s you mean.\r\nexample:{#yellow} 'put leather clothing in the red bag', 'look at unarmed men.'"
}
